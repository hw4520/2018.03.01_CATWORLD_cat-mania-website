...
<article>
<h1>사진첩 글수정</h1>
<form action="updatePro.jsp?num=<%=num%>&pageNum=<%=pageNum%>&prefile_name=<%=gb.getFile()%>" method="post" enctype="multipart/form-data">
<table id="notice">
<tr><td>글쓴이</td>
	   <td><input type="text" name="name" value="<%=gb.getName()%>" readonly></td></tr>
<tr><td>비밀번호</td>
...
<tr><td>내용</td>
	   <td><textarea cols="50" rows="20" name="content"><%=gb.getContent()%></textarea></td></tr>
